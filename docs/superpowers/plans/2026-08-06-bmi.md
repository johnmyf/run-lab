...
const props = defineProps({
  categories: { type: Array, required: true }, // [{ name, min, max, color }]，显示顺序
...
const segments = computed(() => getSegments(props.categories, axisMin.value, axisMax.value))
const boundaries = computed(() => getBoundaryWeights(props.heightCm, props.categories))
